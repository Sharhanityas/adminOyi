            ...
            <form action="{{ route('event.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tanggal_event" value="{{ old('tanggal_event') }}"
                        class="form-control @error('tanggal_event')is-invalid @enderror" placeholder="" />
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" class=" ckeditor form-control @error('deskripsi')is-invalid @enderror"
                        id="ckeditor">{{ old('deskripsi') }}</textarea>
