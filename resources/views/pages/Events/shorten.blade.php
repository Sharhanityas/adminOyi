...
@section('content')
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            @endif
            <form action="{{ route('event_shorten.update', $item->id) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label for="judul_artikel" class="form-control-label">Judul Event</label>
                    <input type="text" name="judul_artikel" value="{{ $item->judul_event }}" class="form-control" readonly />
                </div>
