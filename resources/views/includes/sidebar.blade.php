        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="{{ route('event_galleries.index') }}"> <i class="menu-icon fa fa-list"></i>Lihat  Foto Events</a>
                    </li>
                    <li class="">
                    ...
                    <li class="">
                        <a href="{{ route('article_galleries.index') }}"> <i class="menu-icon fa fa-list"></i>Lihat  Foto Artikel</a>
                    </li>
                    <li class="">
                        <a href="{{ route('article_galleries.create') }}"> <i class="menu-icon fa fa-plus"></i>Tambah Foto Artikel</a>
                    </li>
                    ...
                    <li class="">
                        <a href="{{ route('review_galleries.index') }}"> <i class="menu-icon fa fa-list"></i>Lihat  Foto Review</a>
                    </li>
                    <li class="">
                        <a href="{{ route('review_galleries.create') }}"> <i class="menu-icon fa fa-plus"></i>Tambah Foto Review</a>
                    </li>
